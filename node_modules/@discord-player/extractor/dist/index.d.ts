...
declare const getFetch: typeof fetch | ((...params: unknown[]) => Promise<any>);
...
export { AppleMusicExtractor, AttachmentExtractor, index as Internal, LyricsData, ReverbnationExtractor, SoundCloudExtractor, SpotifyExtractor, StreamFN, VimeoExtractor, YoutubeExtractor as YouTubeExtractor, YouTubeLibs, YoutubeExtractor, createImport, getFetch, loadYtdl, lyricsExtractor, makeYTSearch, version };
